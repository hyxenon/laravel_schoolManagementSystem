<div class="container py-6 mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <button type="button" wire:click="openAddDepartmentModal"
            class="inline-flex items-center px-4 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg gap-x-2 hover:bg-blue-700">
            Add Department
        </button>
    </div>
    ...
    <div class="mb-6 bg-white rounded-lg shadow-lg">
        ...
        <div class="px-6 py-4">
            ...
            <button class="mt-3 text-sm text-indigo-600 hover:text-indigo-800"
                wire:click="openAddCourseModal({{ $department->id }})">
                + Add Course
            </button>
        </div>
    </div>
        ...
        <div class="w-full max-w-md p-6 mx-4 space-y-6 bg-white shadow-2xl rounded-xl sm:max-w-lg sm:mx-0">
            ...
            <div class="flex items-center justify-between pb-4 border-b">
                ...
                <button wire:click="closeModal"
                    class="p-2 text-gray-500 transition duration-150 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400">
            ...
            <form wire:submit.prevent="{{ $isEdit ? 'updateDepartment' : 'createDepartment' }}" class="space-y-4">
                <div class="flex flex-col">
                    <label for="department_code" class="text-sm font-medium text-gray-700">Department Code</label>
                    <input type="text" wire:model="department_code" id="department_code"
                        class="w-full px-4 py-3 mt-1 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="CECT" required>
                </div>
                <div class="flex flex-col">
                    <label for="departmentName" class="text-sm font-medium text-gray-700">Department Name</label>
                    <input type="text" wire:model="departmentName" id="departmentName"
                        class="w-full px-4 py-3 mt-1 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="College of Engineering" required>

                </div>
                <div class="flex flex-col">
                    <label for="programHeadId" class="text-sm font-medium text-gray-700">Program Head ID
                        (Optional)</label>
                    <input type="text" wire:model="programHeadId" id="programHeadId"
                        class="w-full px-4 py-3 mt-1 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div class="flex justify-between">
                    ...
                    <button type="button" wire:click="confirmDelete"
                        class="px-4 py-2 text-sm text-white transition duration-150 ease-in-out bg-red-600 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                        Delete Department
                    </button>
                    @endif
                    ...
                    <div class="flex space-x-2">
                        <button type="button" wire:click="closeModal"
                            class="px-4 py-2 text-sm text-gray-700 transition duration-150 ease-in-out bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400">
                            Cancel
                        </button>
                        <button type="submit"
                            class="px-4 py-2 text-sm text-white transition duration-150 ease-in-out bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
    ...
    <div class="fixed inset-0 z-[70] flex items-center justify-center bg-black bg-opacity-50">
        <div class="w-full max-w-md p-6 mx-4 space-y-6 bg-white shadow-2xl rounded-xl sm:max-w-lg sm:mx-0">
            ...
            <div class="flex items-center justify-between pb-4 border-b">
                ...
                <button wire:click="closeCourseModal"
                    class="p-2 text-gray-500 transition duration-150 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <form wire:submit.prevent="{{ $isCourseEdit ? 'updateCourse' : 'createCourse' }}" class="space-y-4">
                <div class="flex flex-col">
                    ...
                    <input wire:model="course_code" id="course_code"
                        class="w-full px-4 py-3 mt-1 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        rows="3" placeholder="BSIT" required></input>

                </div>
                <div class="flex flex-col">
                    <label for="courseName" class="text-sm font-medium text-gray-700">Course Name</label>
                    <input type="text" wire:model="courseName" id="courseName"
                        class="w-full px-4 py-3 mt-1 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        placeholder="Bachelor of Science in Information Technology" required>
    ...
    <div class="fixed inset-0 z-[70] flex items-center justify-center bg-black bg-opacity-50">
        <div class="w-full max-w-md p-6 mx-4 space-y-6 bg-white shadow-2xl rounded-xl sm:max-w-lg sm:mx-0">
            ...
            <div class="flex items-center justify-between pb-4 border-b">
                ...
                <button wire:click="closeDeleteCourseModal"
                    class="p-2 text-gray-500 transition duration-150 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Modal Body -->
            <p>Are you sure you want to delete the course <strong>{{ $courseName }}</strong>? This action cannot be
                undone.</p>
    ...
    <div class="fixed inset-0 z-[70] flex items-center justify-center bg-black bg-opacity-50">
        <div class="w-full max-w-md p-6 mx-4 space-y-6 bg-white shadow-2xl rounded-xl sm:max-w-lg sm:mx-0">
            ...
            <div class="flex items-center justify-between pb-4 border-b">
                ...
                <button wire:click="closeDeleteDepartmentModal"
                    class="p-2 text-gray-500 transition duration-150 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Modal Body -->
            <p>Are you sure you want to delete the department <strong>{{ $departmentName }}</strong>? This action cannot
                be undone.</p>
